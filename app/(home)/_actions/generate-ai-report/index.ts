...
export const generateAiReport = async ({ month }: GenerateAiReportSchema) => {
  ...
  ${transactions
    ...
    .join(";")}`;
  //completion são várias modelos do OpenAI
  //    model: "gpt-4o-mini", é o mais em conta.. quanto mais caro.. maior a assertividade
  // falando a IA quem ela é - qual profissão
